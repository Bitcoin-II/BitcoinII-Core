...
For users of the now deprecated BitcoinII-Core Releases versions 29.0.0 and 29.0.1, BitcoinII-Core Release Version 29.1.0 is a MANDATORY update!
...
BitcoinII Organization, as well as updated checkpoints. 

To upgrade, simply shut down your BitcoinII node and replace the binary itself. In some instances, BitcoinII Core may request to rescan or resysnc
...
Users of Legacy Windows 64 Bit Operating Systems (Windows 7 versions) will need to use the BitcoinII Legacy Binary (version 27.1) available at: https://github.com/BitcoinII-Dev/BitcoinII.
...
blocks once the majority of the network completes the upgrade to BitcoinII v29.1.0.
...
In the event BitcoinII Core v29.1.0 does not recognize a wallet.dat file generated by BitcoinII Core v27.0.0, you
