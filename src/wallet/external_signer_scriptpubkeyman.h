...
#ifndef BITCOINII_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BITCOINII_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BITCOINII_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
