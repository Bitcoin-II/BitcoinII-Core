...
#ifndef BITCOINII_WALLET_WALLETUTIL_H
#define BITCOINII_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitcoinII from opening the wallet, thinking it was newly created, and
...
#endif // BITCOINII_WALLET_WALLETUTIL_H
