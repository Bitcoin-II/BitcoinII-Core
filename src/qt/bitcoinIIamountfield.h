...
/** Widget for entering bitcoinII amounts.
  */
class BitcoinIIAmountField: public QWidget
{
    Q_OBJECT
...
public:
    explicit BitcoinIIAmountField(QWidget *parent = nullptr);
    ...
    void setDisplayUnit(BitcoinIIUnit new_unit);
