...
#ifndef BITCOINII_SCRIPT_SCRIPT_H
#define BITCOINII_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, BitcoinII always counted CHECKMULTISIGs
...
#endif // BITCOINII_SCRIPT_SCRIPT_H
