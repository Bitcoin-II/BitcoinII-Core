...
#ifndef BITCOINII_COMMON_SIGNMESSAGE_H
#define BITCOINII_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's bitcoinII address, it must refer to a public key.
...
#endif // BITCOINII_COMMON_SIGNMESSAGE_H
