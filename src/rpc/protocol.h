...
#ifndef BITCOINII_RPC_PROTOCOL_H
#define BITCOINII_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in bitcoinIId
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< BitcoinII is not connected
...
#endif // BITCOINII_RPC_PROTOCOL_H
