...
#ifndef BITCOINII_TEST_SCRIPTNUM10_H
#define BITCOINII_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitcoinII Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINII_TEST_SCRIPTNUM10_H
